...
> **版本:** 1.0  
> **最后更新:** 2025-12-02  
> **相关文档:** [BRN-007](../../origin/BRN-007.app_env_design.md) | [IRD-007](../infra/IRD-007.app_env_infra.md)
...
| .env 泄露密码 | .gitignore + Vault（staging/prod） |
| 多环境端口冲突 | 脚本启动前检查端口 |

## 8. 参考

- [BRN-007: 环境决策](../../origin/BRN-007.app_env_design.md)
- [IRD-007: 基础设施](../infra/IRD-007.app_env_infra.md)

...
2. **Work Block Execution**
   - Pick the highest priority task from `plan.md`.
   - Before editing, inspect existing docs/code to reuse material (SSOT rule).
   - Implement the change, run required tests/data checks, and capture evidence.

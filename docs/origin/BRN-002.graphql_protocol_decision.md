...
```
docs/
  origin/BRN-002.graphql_protocol_decision.md
libs/
  schema/ (schema.graphql + {common,market,news}/ SDL)
apps/
  backend/
    src/
      api/graphql/            # Strawberry schema + FastAPI router
      core/services/          # 业务服务层
      infra/neo4j/            # neomodel models + Cypher repos
      main.py                 # FastAPI entry mounting /graphql
  regression/                 # GraphQL e2e checks
tools/
  dev.sh                      # 启停 & codegen helper
```

...
- The mobile app consumes the ping response defined in `libs/schema/stock.proto`. A JSON descriptor generated via `npx pbjs -t json` lives under `apps/mobile/src/proto/stock_descriptor.json`.

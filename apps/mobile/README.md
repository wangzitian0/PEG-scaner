...
- The mobile app consumes the ping response defined in `libs/schema/ping.proto`. A JSON descriptor generated via `npx pbjs -t json` lives under `apps/mobile/src/proto/ping_descriptor.json`.

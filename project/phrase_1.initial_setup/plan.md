...
|---|--------------|-------------|-------|--------|
| 1 | Prompt Logging | Keep `project/prompt_log.md` and iteration logs up to date (single source). | Codex | Completed |
...
| 7 | Execution Tracking | Update `project/README.md`, `docs/README.md`, and `TODOWRITE.md` as milestones complete. | Codex | In Progress |
| 8 | Baseline Snapshot | Capture repo trees and run backend smoke tests to understand current health. | Codex | Completed |
